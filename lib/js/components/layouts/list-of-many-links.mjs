...
const KeyMomentModel = _AbstractStructModel.createClass(
  ...
  , ListOfManyLinksLayoutModel = _BaseLayoutModel.createClass(
        'ListOfManyLinksLayoutModel'
        , ...timeControlModelMixin
...
// Placeholder controller class for this layout
class ListOfManyLinksController extends _BaseContainerComponent {
...
export {
    ListOfManyLinksLayoutModel as Model
  , ListOfManyLinksController as Controller
};
